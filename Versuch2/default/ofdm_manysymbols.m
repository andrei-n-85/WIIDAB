...
% SENDER
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
L = 500; % Number of OFDM symbols
N = 512; % Number of subcarriers (without DC); N hast to be larger than 1
...
CP_duration = 144; % Duration of Cyclic Prefix in samples; CP_duration has to be smaller than T_u
